        ...
        <div className="intro-container">
              ...
              <div className="highlight-box">
                ...
                <div>
                  ...
                  <p className="list-description">
                    Minimal dependiencies and simple learning curve for additioonal
                    technologies
                  </p>
                </div>
              </div>
          ...
          <div className="description">
            ...
            <p>
              ...
              Lifecycle Dashboard renders pod metrics and suggests solutions for unhealthy pods.
            </p>
          </div>
          <figure className="features-container">
            <div className="features-square">
              ...
              <p className="features-paragraph">
                No more forgetting to manually query to find pods stuck in pending phase. 
                Instead, customize email or slack alerts that will suggest solutions in a timely fashion.
              </p>
            </div>
            <div className="features-square">
              <div className="features-icon">
              ...
              <p className="features-paragraph">
                See just how much efficiency you gain by applying Ekkremis solutions. 
                The Ekkremis electron app has preconfigured queries and charts organized 
                by pod lifecycle status. 
              </p>
            </div>
            <div className="features-square">
              <div className="features-icon">
              ...
              <p className="features-paragraph">
                View resource usage and other metrics for individual pods or whole clusters. 
                Ekkremis abstracts the difficulties of PromQl and provides you with easy to 
                interpret lightweight charts.
              </p>
            </div>
            <div className="features-square">
              <div className="features-icon">
              ...
              There are a variety of common reasons and Ekkremis can identfiy them.
              </p>
            </div>
          </figure>
        </div>
